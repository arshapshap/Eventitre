 ...
 */
 class TimeLineLayoutGroup : ViewGroup {
    ...
    private var dividerColorId: Int = R.color.color_on_background_20
    private var dividerTextColorId: Int = com.arshapshap.common_ui.R.color.white
    ...
    override fun onLayout(p0: Boolean, p1: Int, p2: Int, p3: Int, p4: Int) {
        ...
        for (i in 0 until childCount) {
            val child = getChildAt(i) as EventView
...
//            offset for divider applied
    ...
    private fun calculateNewChildPlaceLeft(index: Int, child: EventView): Int {
        for (i in 0 until index) {
            val childToCheckForSpace = getChildAt(i) as EventView
